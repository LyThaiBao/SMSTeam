...
export default function Faculty({ faculty }: FacultyProp) {
  ...
  return (
    <section className=" px-2 py-5 rounded-2xl group overflow-hidden flex flex-col h-74 gap-6 text-black  bg-red-50 ">
      <div className="bg-[#EAF2FB] h-[80%] relative -mx-2 -my-5 py-5">
        <span className="bg-[#3c85cf] py-4 text-white font-bold px-5 rounded-[50%] absolute left-[50%]  top-[50%] -translate-x-[50%] -translate-y-[50%] ">
          {faculty.code}
        </span>
      </div>
      <div className="py-5 border-b border-[#ddd]">
        <div className="flex justify-between ">
          ...
          <span className="px-2 py-1/2 border border-blue-300 bg-blue-200 text-blue-500 rounded-2xl">
      ...
      <div className="flex justify-between items-center">
        ...
        <button
          ...
          className="transition-all bg-black cursor-pointer p-4 text-white rounded-2xl"
        >
          Xem Chi Tiet
        </button>
      </div>
